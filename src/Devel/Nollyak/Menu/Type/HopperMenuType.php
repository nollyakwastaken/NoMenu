...
use Devel\Nollyak\Menu\Definition\Type\HopperMenuDefinition;
...
final class HopperMenuType extends MenuImpl
{
    ...
    {
        parent::__construct($position, new HopperMenuDefinition());
    }
    ...
    public function renderMenu(Player $player): void
    {
        ...
        $packet->blockId = BlockIds::HOPPER_BLOCK;
        $packet->blockData = 0;
