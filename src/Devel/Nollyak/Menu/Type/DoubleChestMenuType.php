...
use Devel\Nollyak\Menu\Definition\Type\DoubleChestMenuDefinition;
...
final class DoubleChestMenuType extends MenuImpl
{
    ...
    {
        parent::__construct($position, new DoubleChestMenuDefinition());
    }
    ...
    public function renderMenu(Player $player): void
    {
        ...
        $compound = new CompoundTag("", [
            ...
            new IntTag("pairx", $position->getFloorX() + 1),
            new IntTag("pairz", $position->getFloorZ())
        ]);
    ...
    public function destroyMenu(Player $player): void
    {
        ...
        $packet->x = $this->getMenuHolder()->getPosition()->getFloorX() + 1;
        $packet->y = $this->getMenuHolder()->getPosition()->getFloorY();
        $packet->z = $this->getMenuHolder()->getPosition()->getFloorZ();
        ...
        $packet->blockId = $this->getMenuHolder()
            ->getPosition()
            ->getLevel()
            ->getBlockIdAt($this->getMenuHolder()->getPosition()->getFloorX() + 1, $this->getMenuHolder()->getPosition()->getFloorY(), $this->getMenuHolder()->getPosition()->getFloorZ());

        $packet->blockData = $this->getMenuHolder()
            ->getPosition()
            ->getLevel()
            ->getBlockDataAt($this->getMenuHolder()->getPosition()->getFloorX() + 1, $this->getMenuHolder()->getPosition()->getFloorY(), $this->getMenuHolder()->getPosition()->getFloorZ());
